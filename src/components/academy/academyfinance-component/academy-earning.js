...
export default function AcademyEarning() {
      ...
      <CardContent>
        <Grid container spacing={3}>
          <Grid item md={6} xs={12}>
            <TextField
              error={Boolean(formik.touched.SponsorForAcademy && formik.errors.SponsorForAcademy)}
              fullWidth
              helperText={formik.touched.SponsorForAcademy && formik.errors.SponsorForAcademy}
              label="Sponsor For Academy"
              margin="dense"
              name="SponsorForAcademy"
              onBlur={formik.handleBlur}
              onChange={formik.handleChange}
              type="text"
              value={formik.values.SponsorForAcademy}
              variant="outlined"
            />
          </Grid>
